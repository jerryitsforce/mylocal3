...
define([
    ...
    'prototype',
    'jquery/ui'
], function (jQuery, _, tinyMCE, varienGlobalEvents, wysiwygEvents, alert) {
    'use strict';
    ...
    tinyMceWysiwyg.prototype = {
        ...
        getSettings: function () {
            ...
            const maxSizeMessage = this.translate('檔案大小超過限制！最大允許：5 MB。請選擇較小的檔案後重新上傳。');
            settings = {
                selector: '#' + this.getId(),
                theme: 'silver',
                skin: 'oxide',
        ...
        openFileBrowser: function (o) {
            var typeTitle = this.translate('Select Images'),
                ...
                toxDialog = jQuery('.tox-dialog-wrap'),
                self = this,
            ...
            // Hide TinyMCE 4 dialog (mce-container) and TinyMCE 5/6 dialog (tox-dialog)
            frameDialog.hide();
