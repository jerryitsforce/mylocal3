    ...
    return Element.extend({
        ...
        reload: function (options) {
            if (this.params.namespace=='marketplace_related_product_listing'
                || this.params.namespace=='branch8_yoxi_ticket_record_overview'
                || this.params.namespace=='branch8_general_ticket_record_overview'
                || this.params.namespace=='branch8_family_bonus_record_overview'
                || this.params.namespace=='branch8_general_non_ticket_record_overview'
            ) {
