...
define(
            ...
            _create: function () {
                ...
                $(document).ready(
                    function () {
                        ...
                        $('.mfp-iframe-scaler iframe', parentBody).animate({'opacity': 1}, 500);
                        ...
                        $(document).on(
                            ...
                            function (e) {
                                ...
                                if ($(this).attr('data-post')) {
                                    ...
                                    url = data_url.action + 'product/' + data_url.data.product + '/qty/' + qty + '/form_key/' + from_key + '/uenc/' + data_url.data.uenc + '/magetopquickview/1';
                                } else {
                                    url = $(this).attr('href');
    ...
    return $.magetop.magetop_beforebodyend;
});
