define([
...
], function ($, _, getTotalsAction, totals, quote, Component, ko, confirmation, url, priceUtils, reloadCartItems) {
    'use strict';
    return Component.extend({
        ...
        initialize: function () {
            this._super();
            this.observe('couponCode hasCouponCode hasCouponCodeandError discountAmount');
            ...
            var cCode = quote.totals() && quote.totals().coupon_code;
            if (cCode) {
                this.couponCode(cCode);
