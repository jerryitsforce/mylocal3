            ...
            jQ.ajax({
                ...
                success: function (result) {
                    if (result.status) {
                        ...
                        // dstDoc.close();
                        dstFrame.srcdoc = result.content;
                        ...
                        jQ('#popup-send-email #messages').html(self.getMessageHtml('error error', DOMPurify.sanitize(result.message)));
                    }
                }
            });
        }
