<?php
namespace HotaiConnected\Qware\Controller\Adminhtml\Index;
...
class GetVoucherInfo extends Action
{
    ...
    public function execute()
    {
        ...
        // 檢查 CSRF Token (包含 admin session 驗證)
    ...
    {
        return $this->_authorization->isAllowed('HotaiConnected_Qware::voucher_lookup');
    }
}