...
namespace HotaiConnected\OpenHub\Setup\Patch\Data;
...
class AddOpenHubAttributeSet implements DataPatchInterface
{
    const NEW_ATTRIBUTE_SET_NAME = "ticket_openhub";
    ...
    public function apply()
    {
        $this->createTicketAttributeSetHelper->execute(
            ...
            TicketAttributeCodes::SKIP_CODES_OPENHUB,
            "預設"
        );
    }
