...
class LogisticStatusResponse extends Action implements CsrfAwareActionInterface
{
    ...
    public function execute()
    {
        ...
        $this->_loggerInterface->writeLog('LogisticStatusResponse logisticStage:'. print_r($logisticStage,true));

         // 取出CvsType
        $logisticCvsType = $this->_mainService->getLogisticConfig('logistic_cvs_type') ;
        $this->_loggerInterface->writeLog('LogisticStatusResponse logisticCvsType:'. print_r($logisticCvsType,true));
        ...
        if($logisticStage == 1){
            ...
            $this->_loggerInterface->writeLog('LogisticStatusResponse accountInfo:'. print_r($accountInfo,true));
            ...
            $this->_loggerInterface->writeLog('LogisticStatusResponse logisticMerchantId:'. print_r($logisticMerchantId,true));
            $this->_loggerInterface->writeLog('LogisticStatusResponse logisticHashKey:'. print_r($logisticHashKey,true));
            $this->_loggerInterface->writeLog('LogisticStatusResponse logisticHashIv:'. print_r($logisticHashIv,true));
        ...
        try {
            ...
            $this->_loggerInterface->writeLog('LogisticStatusResponse resposeInfo:'. print_r($resposeInfo,true));
            ...
            if(isset($resposeInfo['RtnCode'])){
                ...
                $this->_loggerInterface->writeLog('LogisticStatusResponse orderInfo:'. print_r($orderInfo,true));
            ...
            $this->_loggerInterface->writeLog('LogisticStatusResponse resposeInfo:'. print_r('(' . $e->getCode() . ')' . $e->getMessage()));
        }
