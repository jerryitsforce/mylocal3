...
class LogisticMapResponse extends Action implements CsrfAwareActionInterface
{
    ...
    public function execute()
    {
        ...
        $this->_loggerInterface->writeLog('MapResponse storeInfo:'. print_r($storeInfo,true));
        ...
        $this->_loggerInterface->writeLog('MapResponse enctyOrderId:'. print_r($enctyOrderId,true));
        $this->_loggerInterface->writeLog('MapResponse orderId:'. print_r($orderId,true));

        // 驗證訂單資訊 (驗證物流方式)
        $shippingMethod = $this->_orderService->getShippingMethod($orderId);
        $this->_loggerInterface->writeLog('MapResponse shippingMethod:'. print_r($shippingMethod,true));
        ...
        $this->_loggerInterface->writeLog('MapResponse paymentMethod:'. print_r($paymentMethod,true));
        ...
        $this->_loggerInterface->writeLog('MapResponse $redirectUrl:'. print_r($redirectUrl,true));
