...
class LogisticChangeStoreResponse extends Action implements CsrfAwareActionInterface
{
    ...
    public function execute()
    {
        ...
        $this->_loggerInterface->writeLog('LogisticChangeStoreResponse storeInfo:'. print_r($storeInfo,true));
        ...
        $this->_loggerInterface->writeLog('LogisticChangeStoreResponse enctyOrderId:'. print_r($enctyOrderId,true));
        $this->_loggerInterface->writeLog('LogisticChangeStoreResponse orderId:'. print_r($orderId,true));

        // 判斷訂單是否允許更改

        // 物流單建立狀態
        $ecpayShippingTag = $this->_orderService->getEcpayShippingTag($orderId);
        $this->_loggerInterface->writeLog('LogisticChangeStoreResponse $ecpayShippingTag:'.$ecpayShippingTag);
