...
#[AllowDynamicProperties] class Logistic {
    ...
    public function changeStore($orderId, $protectCode)
    {
        ...
        $this->_loggerInterface->writeLog('changeStore ecpayEnableLogistic:'. print_r($ecpayEnableLogistic,true));
        ...
        $this->_loggerInterface->writeLog('changeStore enctyOrderId:'. print_r($enctyOrderId,true));
        $this->_loggerInterface->writeLog('changeStore orderId:'. print_r($orderId,true));

        // 取出訂單protect_code資訊
        $protectCodeFromOrder = $this->_orderService->getProtectCode($orderId);
        $this->_loggerInterface->writeLog('changeStore protectCodeFromOrder:'. print_r($protectCodeFromOrder,true));

        // 驗證訂單欄位protect_code 是否正確
        if($protectCodeFromOrder != $protectCode){

            $this->_loggerInterface->writeLog('changeStore protect_code驗證錯誤:'. print_r($protectCode,true));
        ...
        $this->_loggerInterface->writeLog('changeStore $ecpayShippingTag:'.$ecpayShippingTag);
        ...
        $this->_loggerInterface->writeLog('changeStore $shippingMethod:'.$shippingMethod);

        // 貨到付款判斷
        $paymentMethod = $this->_orderService->getPaymentMethod($orderId);
        $this->_loggerInterface->writeLog('changeStore paymentMethod:'.$paymentMethod);
        ...
        $this->_loggerInterface->writeLog('changeStore logisticStage:'. print_r($logisticStage,true));

        // 取出CvsType
        $logisticCvsType = $this->_mainService->getLogisticConfig('logistic_cvs_type') ;
        $this->_loggerInterface->writeLog('changeStore logisticCvsType:'. print_r($logisticCvsType,true));

        // 取出 URL
        $apiUrl = $this->_logisticService->getApiUrl('map', $logisticStage);
        $this->_loggerInterface->writeLog('changeStore apiUrl:'. print_r($apiUrl,true));
        ...
        if($logisticStage == 1){
            ...
            $this->_loggerInterface->writeLog('changeStore accountInfo:'. print_r($accountInfo,true));
            ...
            $this->_loggerInterface->writeLog('changeStore logisticMerchantId:'. print_r($logisticMerchantId,true));
            $this->_loggerInterface->writeLog('changeStore logisticHashKey:'. print_r($logisticHashKey,true));
            $this->_loggerInterface->writeLog('changeStore logisticHashIv:'. print_r($logisticHashIv,true));
        ...
        $this->_loggerInterface->writeLog('changeStore logisticOrderPreFix:'. print_r($logisticOrderPreFix,true));

        // 組合廠商訂單編號
        $merchantTradeNo = $this->_orderService->getMerchantTradeNo($orderId, $logisticOrderPreFix);
        $this->_loggerInterface->writeLog('changeStore merchantTradeNo:'. print_r($merchantTradeNo,true));

        // 貨態回傳網址
        $serverReplyURL = $this->_urlInterface->getUrl("ecpaygeneral/Process/LogisticChangeStoreResponse");
        $this->_loggerInterface->writeLog('changeStore serverReplyURL:'. print_r($serverReplyURL,true));

        // 取出物流子類型
        $logisticsSubType = $this->_logisticService->getCvsLogisticsSubType($logisticCvsType, $shippingMethod);
        $this->_loggerInterface->writeLog('changeStore logisticsSubType:'. print_r($logisticsSubType,true));
    ...
    public function createOrder($orderId, $protectCode)
    {
        ...
        $this->_loggerInterface->writeLog('createLogisticOrder ecpayEnableLogistic:'. print_r($ecpayEnableLogistic,true));
        ...
        // 取出訂單protect_code資訊
        $protectCodeFromOrder = $this->_orderService->getProtectCode($orderId);
        $this->_loggerInterface->writeLog('createLogisticOrder protectCodeFromOrder:'. print_r($protectCodeFromOrder,true));

        // 驗證訂單欄位protect_code 是否正確
        if ($protectCodeFromOrder != $protectCode) {

            $this->_loggerInterface->writeLog('createLogisticOrder protect_code驗證錯誤:'. print_r($protectCode,true));
    ...
    public function printOrder($orderId, $protectCode)
    {
        ...
        // 判斷模組是否啟動
        $ecpayEnableLogistic = $this->_mainService->getMainConfig('ecpay_enabled_logistic') ;
        $this->_loggerInterface->writeLog('printOrder ecpayEnableLogistic:'. print_r($ecpayEnableLogistic,true));
        ...
        $this->_loggerInterface->writeLog('printOrder enctyOrderId:'. print_r($enctyOrderId,true));
        $this->_loggerInterface->writeLog('printOrder orderId:'. print_r($orderId,true));

        // 取出訂單protect_code資訊
        $protectCodeFromOrder = $this->_orderService->getProtectCode($orderId);
        $this->_loggerInterface->writeLog('printOrder protectCodeFromOrder:'. print_r($protectCodeFromOrder,true));

        // 驗證訂單欄位protect_code 是否正確
        if($protectCodeFromOrder != $protectCode){

            $this->_loggerInterface->writeLog('printOrder protect_code驗證錯誤:'. print_r($protectCode,true));
        ...
        // 物流單建立狀態
        $ecpayShippingTag = $this->_orderService->getEcpayShippingTag($orderId);
        $this->_loggerInterface->writeLog('printOrder $ecpayShippingTag:'.$ecpayShippingTag);
        ...
        // 物流方式
        $shippingMethod = $this->_orderService->getShippingMethod($orderId);
        $this->_loggerInterface->writeLog('printOrder $shippingMethod:'.$shippingMethod);
        ...
        // 取出是否為測試模式
        $logisticStage = $this->_mainService->getLogisticConfig('enabled_logistic_stage') ;
        $this->_loggerInterface->writeLog('printOrder logisticStage:'. print_r($logisticStage,true));

        // 取出CvsType
        $logisticCvsType = $this->_mainService->getLogisticConfig('logistic_cvs_type') ;
        $this->_loggerInterface->writeLog('printOrder logisticCvsType:'. print_r($logisticCvsType,true));

        // 取出 URL
        $apiUrl = $this->_logisticService->getApiUrl('print', $logisticStage, $logisticCvsType, $shippingMethod);
        $this->_loggerInterface->writeLog('printOrder apiUrl:'. print_r($apiUrl,true));
        ...
        if($logisticStage == 1){
            ...
            // 取出 KEY IV MID (測試模式)
            $accountInfo = $this->_logisticService->getStageAccount($logisticCvsType);
            $this->_loggerInterface->writeLog('printOrder accountInfo:'. print_r($accountInfo,true));
            ...
            $this->_loggerInterface->writeLog('printOrder logisticMerchantId:'. print_r($logisticMerchantId,true));
            $this->_loggerInterface->writeLog('printOrder logisticHashKey:'. print_r($logisticHashKey,true));
            $this->_loggerInterface->writeLog('printOrder logisticHashIv:'. print_r($logisticHashIv,true));
        ...
        $this->_loggerInterface->writeLog('printOrder logisticOrderInfo:'. print_r($logisticOrderInfo,true));
    ...
    public function getShippingMethod($orderId, $protectCode)
    {
        ...
        // 判斷模組是否啟動
        $ecpayEnableLogistic = $this->_mainService->getMainConfig('ecpay_enabled_logistic') ;
        $this->_loggerInterface->writeLog('getShippingMethod ecpayEnableLogistic:'. print_r($ecpayEnableLogistic,true));
        ...
        $this->_loggerInterface->writeLog('getShippingMethod enctyOrderId:'. print_r($enctyOrderId,true));
        $this->_loggerInterface->writeLog('getShippingMethod orderId:'. print_r($orderId,true));

        // 取出訂單protect_code資訊
        $protectCodeFromOrder = $this->_orderService->getProtectCode($orderId);
        $this->_loggerInterface->writeLog('getShippingMethod protectCodeFromOrder:'. print_r($protectCodeFromOrder,true));

        // 驗證訂單欄位protect_code 是否正確
        if($protectCodeFromOrder != $protectCode){

            $this->_loggerInterface->writeLog('getShippingMethod protect_code驗證錯誤:'. print_r($protectCode,true));
        ...
        // 物流方式
        $shippingMethod = $this->_orderService->getShippingMethod($orderId);
        $this->_loggerInterface->writeLog('getShippingMethod $shippingMethod:'.$shippingMethod);
    ...
    public function getShippingTag($orderId, $protectCode)
    {
        ...
        // 判斷模組是否啟動
        $ecpayEnableLogistic = $this->_mainService->getMainConfig('ecpay_enabled_logistic') ;
        $this->_loggerInterface->writeLog('getShippingTag ecpayEnableLogistic:'. print_r($ecpayEnableLogistic,true));
        ...
        $this->_loggerInterface->writeLog('getShippingTag enctyOrderId:'. print_r($enctyOrderId,true));
        $this->_loggerInterface->writeLog('getShippingTag orderId:'. print_r($orderId,true));

        // 取出訂單protect_code資訊
        $protectCodeFromOrder = $this->_orderService->getProtectCode($orderId);
        $this->_loggerInterface->writeLog('getShippingTag protectCodeFromOrder:'. print_r($protectCodeFromOrder,true));

        // 驗證訂單欄位protect_code 是否正確
        if($protectCodeFromOrder != $protectCode){

            $this->_loggerInterface->writeLog('getShippingTag protect_code驗證錯誤:'. print_r($protectCode,true));
        ...
        // 物流單建立狀態
        $ecpayShippingTag = $this->_orderService->getEcpayShippingTag($orderId);
        $this->_loggerInterface->writeLog('getEcpayShippingTag $ecpayShippingTag:'.$ecpayShippingTag);
