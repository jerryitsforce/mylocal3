...
class ThankYou extends Template
{
    ...
    public function getPaymentInfo()
    {
        ...
        $this->_loggerInterface->writeLog('ThankYou Block paymentMethod:'. print_r($paymentMethod,true));
        ...
        $this->_loggerInterface->writeLog('ThankYou Block isEcpayPayment:'. print_r($isEcpayPayment,true));
        ...
        $this->_loggerInterface->writeLog('ThankYou Block paymentInfo:'. print_r($paymentInfo,true));
