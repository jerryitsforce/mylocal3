...
class MethodAvailable
{
    ...
    public function afterGetAvailableMethods(MethodList $subject, $result)
    {
        ...
        $this->_loggerInterface->writeLog('MethodAvailable shippingMethod:'. print_r($shippingMethod,true));

        if (!is_null($shippingMethod) && $this->_logisticService->isEcpayLogistics($shippingMethod)) {
