...
class RegistrationAction extends Column
{
    const GRID_URL_PATH_DELETE = 'notibox/report/delete';
    const GRID_URL_PATH_UNSUBSCRIBE = 'notibox/report/unsubscribe';
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['entity_id'])) {
                    $item[$name]['delete'] = [
                        ...
                        'confirm' => [
                            'title' => __('Delete'),
                            'message' => __('Are you sure you wan\'t to delete this register?')
                        ]
                    ];
                    $item[$name]['unsubscribe'] = [
                        ...
                        'confirm' => [
                            ...
                            'message' => __('Are you sure you wan\'t to unsubscribe this register?')
                        ]
                    ];
                }
            }
