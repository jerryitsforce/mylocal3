...
class Api
{
    ...
    public function aroundDispatch(
        ...
        try {
            ...
            if($isSystemRequest){
                $writer = new \Zend_Log_Writer_Stream(BP .'/var/log/api_request_inf.log');
                $logger = new \Zend_Log();
                $logger->addWriter($writer);
                $logger->info($this->remoteAddress->getRemoteAddress().' --- '.$request->getRequestUri());
            }
