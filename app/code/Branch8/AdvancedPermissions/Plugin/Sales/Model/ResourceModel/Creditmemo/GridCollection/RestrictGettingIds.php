...
namespace Branch8\AdvancedPermissions\Plugin\Sales\Model\ResourceModel\Creditmemo\GridCollection;
...
class RestrictGettingIds
{
    ...
    public function beforeGetAllIds(CreditmemoGridCollection $subject): void
    {
