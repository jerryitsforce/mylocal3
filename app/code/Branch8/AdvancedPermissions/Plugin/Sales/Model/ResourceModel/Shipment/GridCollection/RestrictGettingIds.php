...
namespace Branch8\AdvancedPermissions\Plugin\Sales\Model\ResourceModel\Shipment\GridCollection;
...
class RestrictGettingIds
{
    ...
    public function beforeGetAllIds(ShipmentGridCollection $subject): void
    {
