...
namespace Branch8\AdvancedPermissions\Plugin\Sales\Model\ResourceModel\PaymentTransaction\Collection;
...
class RestrictGettingIds
{
    ...
    public function beforeGetAllIds(PaymentTransactionCollection $subject): void
    {
