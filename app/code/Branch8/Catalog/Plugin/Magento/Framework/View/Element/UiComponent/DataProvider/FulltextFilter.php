<?php
namespace Branch8\Catalog\Plugin\Magento\Framework\View\Element\UiComponent\DataProvider;

use Magento\Framework\Api\Filter;
use Magento\Framework\Data\Collection;
use Magento\Framework\Data\Collection\AbstractDb;
use Magento\Framework\View\Element\UiComponent\DataProvider\SearchResult;
use Magento\Framework\View\Element\UiComponent\DataProvider\FulltextFilter as CoreFulltextFilter;
...
class FulltextFilter
{
     ...
     *
     * @param CoreFulltextFilter $subject
     * @param callable $proceed
     * @param Collection $collection
     * @param Filter $filter
     * @return void
     */
    public function aroundApply(CoreFulltextFilter $subject, callable $proceed, Collection $collection, Filter $filter)
    {
        ...
        if ($mainTable == 'marketplace_userdata') {
            $columns = array_merge($columns, ['`cgf`.name']);
        }
