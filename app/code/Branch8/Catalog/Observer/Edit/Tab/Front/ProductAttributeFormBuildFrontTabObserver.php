 ...
 */
namespace Branch8\Catalog\Observer\Edit\Tab\Front;
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'note' => __('Can be used only with catalog input type Yes/No, Dropdown, Multiple Select and Price. <br>Price is not compatible with <b>\'Filterable (no results)\'</b> option - it will make no affect on Price filter.'),
                'values' => [
                    ['value' => '0', 'label' => __('No')],
