...
class Common
{
     ...
     * @return boolean
     */
    public function IsGeneralNotifyTicketProduct(int $productId): bool
    {
        try {
        ...
        return $virtualProductType->getValue() == VirtualProductType::TYPE_GENERAL_NOTIFY_TICKET;
    }
    ...
    public function writeLogIfEnabled(
        ...
        if (!HotaiCoreDebugLog::isEnable('Branch8_GeneralNotifyTicket', $logOptionValue)) {
            return;
        }
