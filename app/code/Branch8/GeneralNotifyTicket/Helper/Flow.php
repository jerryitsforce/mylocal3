...
namespace Branch8\GeneralNotifyTicket\Helper;

use Branch8\HotaiCore\Helper\Common as HotaiCoreCommonHelper;
use Branch8\GeneralNotifyTicket\Model\Config\Source\LogOption;
...
use Branch8\GeneralNotifyTicket\Model\ResourceModel\GeneralNotifyTicketBatchSetting\Collection as BatchSettingCollection;
use Branch8\GeneralNotifyTicket\Model\ResourceModel\GeneralNotifyTicketBatchSetting\CollectionFactory as BatchSettingCollectionFactory;
...
{
    const LOG_FOLDER_NAME = 'GeneralNotifyTicket/Flow';
    ...
    public function cancelTickets(int $orderItemId): void
    {
        ...
        try {
            ...
            $this->commonHelper->writeLogIfEnabled(
                json_encode([
                    "Title"   => "Something went wrong while executing GeneralNotify cancelTickets transaction.",
    ...
    protected function resetAllocatedRecords(Record $record): void
    {
        ...
        $memoMessage = $this->hotaiCoreCommonHelper->prepareMemoStringForUpdate(
            ...
            [
                ...
                "Title"     => "GeneralNotifyTicket cancelTickets flow resetAllocatedRecords executed.",
        ...
        foreach ($collection->getItems() as $record) {
            ...
            $memoMessage = $this->hotaiCoreCommonHelper->prepareMemoStringForUpdate(
                ...
                [
                    "Timestamp" => time(),
                    "Datetime"  => date("Y-m-d H:i:s"),
                    "Title"     => "GeneralNotifyTicket cancelTickets flow called, set status to STATUS_IMPORTED.",
        ...
        foreach ($collection->getItems() as $record) {
            ...
            $memoMessage = $this->hotaiCoreCommonHelper->prepareMemoStringForUpdate(
                ...
                [
                    "Timestamp" => time(),
                    "Datetime"  => date("Y-m-d H:i:s"),
                    "Title"     => "GeneralNotifyTicket cancelTickets flow called, set status to STATUS_RETURNED.",
                    "Message"   => "Before status: {$beforeStatus}, after status: {$afterStatus}",
                ]
            );
    ...
    {
        $recordTableName = \Branch8\GeneralNotifyTicket\Model\GeneralNotifyTicketRecord::TABLE_NAME;
        $batchTableName = \Branch8\GeneralNotifyTicket\Model\GeneralNotifyTicketBatchSetting::TABLE_NAME;

        $recordIdField = \Branch8\GeneralNotifyTicket\Model\GeneralNotifyTicketRecord::RECORD_ID;
        $batchSettingIdFieldInBatchTable = \Branch8\GeneralNotifyTicket\Model\GeneralNotifyTicketBatchSetting::SETTING_ID;
        $batchSettingIdFieldInRecordTable = \Branch8\GeneralNotifyTicket\Model\GeneralNotifyTicketRecord::BATCH_SETTING_ID;
        $productIdField = \Branch8\GeneralNotifyTicket\Model\GeneralNotifyTicketBatchSetting::BELONG_TO_PRODUCT_ID;
        $batchCodeField = \Branch8\GeneralNotifyTicket\Model\GeneralNotifyTicketBatchSetting::BATCH_CODE;
        $batchSaleStartTimeField = \Branch8\GeneralNotifyTicket\Model\GeneralNotifyTicketBatchSetting::SALE_START_TIME;
        $batchSaleEndTimeField = \Branch8\GeneralNotifyTicket\Model\GeneralNotifyTicketBatchSetting::SALE_END_TIME;
        $statusField = \Branch8\GeneralNotifyTicket\Model\GeneralNotifyTicketRecord::STATUS;
