...
{
    const LOG_FOLDER_NAME = 'GeneralNotifyTicket/Observer/OrderChangeToCanceled';
    ...
    private function prepareUpdateTransactionToImported(TicketRecordModel $record): void
    {
        ...
        $memoMessage = $this->hotaiCoreCommonHelper->prepareMemoStringForUpdate(
            ...
            [
                ...
                "Title"     => "GeneralNotifyTicket OrderChangeToCanceled triggered.",
        ...
        $whereDelete = [
            CustomerTicket::TYPE . ' = ?' => \Branch8\HotaiCore\Model\Product\VirtualProductType::TYPE_GENERAL_NOTIFY_TICKET,
