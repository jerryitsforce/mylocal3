...
namespace Branch8\GeneralNotifyTicket\Observer;

use Branch8\HotaiCore\Helper\Common as HotaiCoreCommonHelper;
use Branch8\GeneralNotifyTicket\Helper\Common as CommonHelper;
...
use Branch8\GeneralNotifyTicket\Model\GeneralNotifyTicketRecord as TicketRecordModel;
use Branch8\GeneralNotifyTicket\Model\GeneralNotifyTicketRecordRepository as TicketRecordRepository;
...
{
    const LOG_FOLDER_NAME = 'TicketSetAllocationObserver';

    private const DEBUG_LOG_OPTION = LogOption::LOG_TICKET_SET_ALLOCATION_OBSERVER;
    ...
    public function execute(Observer $observer)
    {
        ...
        foreach ($quote->getAllVisibleItems() as $item) {
            ...
            if (!$this->commonHelper->IsGeneralNotifyTicketProduct($item->getProductId())) {
                continue;
            }
    ...
    private function setTicketRecordUpdateValue(TicketRecordModel $record, int $quoteItemId): TicketRecordModel
    {
        ...
        $memoMessage = $this->hotaiCoreCommonHelper->prepareMemoStringForUpdate(
            ...
            [
                ...
                "Title"     => "GeneralNotifyTicket TicketSetAllocationObserver triggered by event: {$this->eventName}",
