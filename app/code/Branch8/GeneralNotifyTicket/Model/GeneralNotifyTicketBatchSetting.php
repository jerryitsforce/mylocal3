...
class GeneralNotifyTicketBatchSetting extends AbstractModel implements GeneralNotifyTicketBatchSettingInterface
{
    const TABLE_NAME    = "general_notify_ticket_batch_setting";
    ...
    {
        $this->_init(
            \Branch8\GeneralNotifyTicket\Model\ResourceModel\GeneralNotifyTicketBatchSetting::class
        );
    }
