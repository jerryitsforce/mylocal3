...
class GeneralNotifyTicketRecord extends AbstractModel implements GeneralNotifyTicketRecordInterface
{
    const TABLE_NAME    = "general_notify_ticket_record";
    ...
    {
        $this->_init(
            \Branch8\GeneralNotifyTicket\Model\ResourceModel\GeneralNotifyTicketRecord::class
        );
    }
