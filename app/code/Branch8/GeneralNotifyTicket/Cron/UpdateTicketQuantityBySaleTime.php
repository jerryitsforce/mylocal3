...
namespace Branch8\GeneralNotifyTicket\Cron;
...
use Branch8\GeneralNotifyTicket\Model\GeneralNotifyTicketRecordRepository as RecordRepository;
...
{
    const LOG_FOLDER_NAME = 'GeneralNotifyTicket/Cron/UpdateTicketQuantityBySaleTime';
    ...
    {
        try {
            $this->writeLog("GeneralNotifyTicket UpdateTicketQuantityBySaleTime cron start.");
            ...
            $this->writeLog("GeneralNotifyTicket UpdateTicketQuantityBySaleTime cron end.");
        } catch (\Exception $e) {
    ...
    private function getTargetProductCollection(): ProductCollection
    {
        ...
        $productCollection->addAttributeToSelect(['entity_id', 'sku'])
            ...
            ->addAttributeToFilter(
                ...
                ['eq', VirtualProductType::TYPE_GENERAL_NOTIFY_TICKET]
            )->load();
