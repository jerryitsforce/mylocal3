...
class YoxiTicketRecord extends AbstractModel implements YoxiTicketRecordInterface
{
    const TABLE_NAME    = "yoxi_ticket_record_v2";
    ...
    {
        $this->_init(
            \Branch8\Yoxi\Model\ResourceModel\YoxiTicketRecord::class
        );
    }
