...
use Branch8\Yoxi\Model\Ticket\Synchronizer as TicketSynchronizer;
...
class ReceiveGridForm extends Action
{
    ...
    public function __construct(
        ...
        YoxiTicketRecordFactory $ticketRecordFactory,
        YoxiTicketRecordRepository $ticketRecordRepository,
        YoxiBatchSettingFactory $batchSettingFactory,
        YoxiBatchSettingRepository $batchSettingRepository,
    ...
    public function execute()
    {
        try {
            ...
            if (!$batchSettingSearchResult) {
                throw new \Exception("Can't find YOXI batch setting by giving batch setting id: {$batchSettingId}");
            }
