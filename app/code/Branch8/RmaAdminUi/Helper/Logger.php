...
namespace Branch8\RmaAdminUi\Helper;

use Branch8\HotaiCore\Helper\DebugLog;
use Psr\Log\LoggerInterface;

/**
 * Logger helper for RmaAdminUi
 */
class Logger extends DebugLog
{
    ...
    {
        if ($this->isEnable('Branch8_RmaAdminUi', 'system')) {
    ...
    {
        if ($this->isEnable('Branch8_RmaAdminUi', 'exception')) {
