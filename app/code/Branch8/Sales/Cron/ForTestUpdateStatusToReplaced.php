...
//已送達 -> 已完成換貨
class ForTestUpdateStatusToReplaced
{

    const LOG_PATH = 'cron/ForTestupdateStatusToReplaced/';
    ...
    public function execute()
    {
        ...
        $this->logger->info("------Start Of Cron-Update-Status-To-Replaced-----");
        ...
        $this->logger->info("------End Of Cron-Update-Status-To-Replaced-----");
    }
