...
//換貨派車回收 -> 檢驗中
class ForTestUpdateStatusToApplyingReplaceReview
{

    const LOG_PATH = 'cron/ForTestUpdateStatusToApplyingReplaceReview/';
    ...
    public function execute()
    {
        ...
        $this->logger->info("------Start Of Cron-Update-Status-Applying-Replace-Review-----");
