...
class UpdateStatusToComplete
{

    const LOG_PATH = 'Sales/Cron/updateStatusToComplete';
    ...
    public function execute()
    {
        $this->hotaiCoreCommon->writeLog(
            "------Start Of Cron-Update-Status-Complete-----",
            self::LOG_PATH
        );
    ...
    private function getCheckOrderCollectionList()
    {
        ...
        $from = date('Y-m-d H:i:s', strtotime('-33 days', strtotime($now)));
