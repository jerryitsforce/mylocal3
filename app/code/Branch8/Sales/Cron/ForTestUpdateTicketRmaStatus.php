...
class ForTestUpdateTicketRmaStatus
{

    const LOG_PATH = 'cron/ForTestupdateTicketRmaStatus/';
    ...
    public function execute()
    {
        ...
        foreach ($collection->getData() as $data) {
            try {
                ...
                $this->logger->info("------Update Ticket Rma Status To AVALI -----");
        ...
        $this->logger->info("------End Of Cron-Update-Ticket-Rma-Avail-----");
    }
