...
class Tax extends \Magento\Sales\Model\Order\Creditmemo\Total\AbstractTotal
{
    ...
    public function collect(Creditmemo $creditmemo)
    {
        ...
        foreach ($creditmemo->getAllItems() as $item) {
            ...
            $taxDiff =  $taxDiff + (int) $orderItem->getRowTotalInclTax() - (int) $orderItem->getRowTotal();
        ...
        $creditmemo->setGrandTotal(
            $creditmemo->getGrandTotal() + $totalTax + $totalDiscountTaxCompensation
        
        );
        $creditmemo->setBaseGrandTotal(
            $creditmemo->getBaseGrandTotal() + $baseTotalTax 
            + $baseTotalDiscountTaxCompensation
        );
        return $this;
    }
