...
use Branch8\Blog\Model\ResourceModel\Post\Collection as PostCollection;
...
use Branch8\Blog\Helper\AbstractData as CoreHelper;
    ...
    public function getPostCollection($type = null, $id = null, $storeId = null)
    {
        ...
        switch ($type) {
            ...
            case self::TYPE_CATEGORY:
                $collection->join(
                    ['category' => $collection->getTable('branch8_blog_post_category')],
            ...
            case self::TYPE_TAG:
                $collection->join(
                    ['tag' => $collection->getTable('branch8_blog_post_tag')],
            ...
            case self::TYPE_TOPIC:
                $collection->join(
                    ['topic' => $collection->getTable('branch8_blog_post_topic')],
