...
use Branch8\Blog\Model\Config\Source\DisplayType;
...
class Listpost extends Frontend
{
    ...
    protected function getBreadcrumbsData()
    {
        ...
        if ($this->getRequest()->getFullActionName() !== 'blog_post_index') {
    ...
    public function applySeoCode()
    {
        ...
        if ($this->getRequest()->getFullActionName() === 'blog_post_view' && $url) {
