...
use Branch8\Blog\Block\Adminhtml\Renderer\Image;
use Branch8\Blog\Helper\Data;
use Branch8\Blog\Helper\Image as ImageHelper;
use Branch8\Blog\Model\Config\Source\AuthorStatus;

/**
 * Class Author
 * @package Branch8\Blog\Block\Adminhtml\Author\Edit\Tab
 */
class Author extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $author = $this->_coreRegistry->registry('branch8_blog_author');
    ...
    {
        return $this->getUrl('branch8_blog/author/customergrid');
    }
}
