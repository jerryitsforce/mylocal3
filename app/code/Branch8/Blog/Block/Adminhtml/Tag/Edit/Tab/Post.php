...
namespace Branch8\Blog\Block\Adminhtml\Tag\Edit\Tab;
...
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('branch8_blog_post_tag')],
    ...
    /**
     * @return \Branch8\Blog\Model\Tag
     */
    public function getTag()
    {
        return $this->coreRegistry->registry('branch8_blog_tag');
    }
    ...
    {
        return $this->getUrl('branch8_blog/tag/posts', ['_current' => true]);
    }
