...
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('branch8_blog_post_topic')],
    ...
    /**
     * @return \Branch8\Blog\Model\Topic
     */
    public function getTopic()
    {
        return $this->coreRegistry->registry('branch8_blog_topic');
    }
    ...
    {
        return $this->getUrl('branch8_blog/topic/posts', ['_current' => true]);
    }
