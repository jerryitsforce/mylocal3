...
use Branch8\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\Category;
use Branch8\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\Tag;
use Branch8\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\Topic;
use Branch8\Blog\Helper\Image;
use Branch8\Blog\Model\Config\Source\Author;
...
class Post extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $post = $this->_coreRegistry->registry('branch8_blog_post');
        ...
        $fieldset->addField('image_two', \Branch8\Blog\Block\Adminhtml\Renderer\Image::class, [
            'name'  => 'image_two',
            'label' => __('Image 2'),
            'title' => __('Image 2'),
            'path'  => $this->imageHelper->getBaseMediaPath(Image::TEMPLATE_MEDIA_TYPE_POST),
        ...
        $fieldset->addField('image_three', \Branch8\Blog\Block\Adminhtml\Renderer\Image::class, [
            'name'  => 'image_three',
            'label' => __('Image 3'),
            'title' => __('Image 3'),
            'path'  => $this->imageHelper->getBaseMediaPath(Image::TEMPLATE_MEDIA_TYPE_POST),
