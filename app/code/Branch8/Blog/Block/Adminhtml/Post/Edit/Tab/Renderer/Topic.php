...
namespace Branch8\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer;
...
use Branch8\Blog\Model\ResourceModel\Topic\Collection;
use Branch8\Blog\Model\ResourceModel\Topic\CollectionFactory as BlogTopicCollectionFactory;
...
class Topic extends Multiselect
{
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Branch8_Blog::topic');
    ...
    public function getAfterElementHtml()
    {
        $html = '<script type="text/x-magento-init">
                    ...
                    "Magento_Ui/js/core/app": {
                        "components": {
                            "blogTopic": {
                                ...
                                "children": {
                                    "blog_select_topic": {
                                        "component": "Branch8_Blog/js/components/new-category",
                                        "config": {
                                            "filterOptions": true,
                                            "disableLabel": true,
                                            "chipsEnabled": true,
            ...
            $this->_urlBuilder->getUrl(
                ...
                [
                    'handle' => 'branch8_blog_topic_create',
                    'buttons' => 1
                ]
            ) . '",
                                        "autoRender": false,
