...
use Branch8\Blog\Model\ResourceModel\Tag\Collection;
use Branch8\Blog\Model\ResourceModel\Tag\CollectionFactory as BlogTagCollectionFactory;
...
class Tag extends Multiselect
{
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Branch8_Blog::tag');
    ...
    public function getAfterElementHtml()
    {
        $html = '<script type="text/x-magento-init">
            ...
            $this->_urlBuilder->getUrl(
                ...
                [
                    'handle' => 'branch8_blog_tag_create',
                    'buttons' => 1
                ]
            ) . '",
                                        "autoRender": false,
