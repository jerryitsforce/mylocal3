...
use Branch8\Blog\Model\ResourceModel\Category\CollectionFactory as BlogCategoryCollectionFactory;
...
class Category extends Multiselect
{
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Branch8_Blog::category');
    ...
    public function getAfterElementHtml()
    {
        $html = '<script type="text/x-magento-init">
            ...
            $this->_urlBuilder->getUrl(
                ...
                ['handle' => 'branch8_blog_category_create', 'buttons' => 1]
            ) . '",
                                        "autoRender": false,
