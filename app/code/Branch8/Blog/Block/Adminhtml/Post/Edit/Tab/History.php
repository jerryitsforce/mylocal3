...
namespace Branch8\Blog\Block\Adminhtml\Post\Edit\Tab;
...
use Branch8\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\History\Action;
use Branch8\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\History\Author;
use Branch8\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\History\Categories;
use Branch8\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\History\Store;
use Branch8\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\History\Tags;
use Branch8\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\History\Topics;
use Branch8\Blog\Model\AuthorFactory;
use Branch8\Blog\Model\ResourceModel\PostHistory\Collection;
use Branch8\Blog\Model\Tag;

/**
 * Class Product
 * @package Branch8\Blog\Block\Adminhtml\Post\Edit\Tab
 */
class History extends Extended implements TabInterface
{
     ...
     * @param \Branch8\Blog\Helper\Data $_helperData
     * @param array $data
     */
    public function __construct(
        ...
        \Branch8\Blog\Helper\Data $_helperData,
        array $data = []
    ) {
    ...
    /**
     * @return \Branch8\Blog\Model\Post
     */
    public function getPost()
    {
        return $this->coreRegistry->registry('branch8_blog_post');
    }
    ...
    {
        return $this->getUrl('branch8_blog/post/history', ['_current' => true]);
    }
