...
namespace Branch8\Blog\Block\Adminhtml\Comment\Edit\Tab;
...
use Branch8\Blog\Model\Config\Source\Comments\Status;
use Branch8\Blog\Model\PostFactory;

/**
 * Class Comment
 * @package Branch8\Blog\Block\Adminhtml\Comment\Edit\Tab
 */
class Comment extends Generic implements TabInterface
{
    ...
    {
        $comment = $this->_coreRegistry->registry('branch8_blog_comment');
        ...
        $postText = '<a href="' . $this->getUrl('branch8_blog/post/edit', ['id' => $comment->getPostId()])
