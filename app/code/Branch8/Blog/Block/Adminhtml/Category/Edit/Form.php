...
namespace Branch8\Blog\Block\Adminhtml\Category\Edit;
...
use Branch8\Blog\Model\Category as BlogCategory;
use Branch8\Blog\Model\CategoryFactory as BlogCategoryFactory;
use Branch8\Blog\Model\ResourceModel\Category\Tree as BlogResourceTree;

/**
 * Class Form
 * @package Branch8\Blog\Block\Adminhtml\Category\Edit
 */
class Form extends AbstractCategory
{
    ...
    protected function _prepareLayout()
    {
        ...
        if ($categoryId && $categoryId != 1 && !$this->getRequest()->getParam('duplicate')) {
            $this->addButton('delete', [
                ...
                'onclick' => "categoryDelete('" . $this->getUrl('branch8_blog/*/delete', ['_current' => true]) . "')",
                'class'   => 'delete'
            ]);
        }

        // Reset button
        $resetPath = $categoryId ? 'branch8_blog/*/edit' : 'branch8_blog/*/add';
    ...
    public function getSaveUrl(array $args = [])
    {
        ...
        return $this->getUrl('branch8_blog/*/save', $params);
    }
    ...
    {
        return $this->getUrl('branch8_blog/category/edit', ['_query' => false, 'id' => null, 'parent' => null]);
    }
    ...
    public function getDeleteUrl(array $args = [])
    {
        ...
        return $this->getUrl('branch8_blog/*/delete', $params);
    }
    ...
    public function getRefreshPathUrl(array $args = [])
    {
        ...
        return $this->getUrl('branch8_blog/*/refreshPath', $params);
    }
