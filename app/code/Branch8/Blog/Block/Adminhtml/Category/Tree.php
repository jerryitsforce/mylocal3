...
namespace Branch8\Blog\Block\Adminhtml\Category;
...
use Branch8\Blog\Model\ResourceModel\Category\Tree as BlogTreeResource;
...
class Tree extends \Magento\Catalog\Block\Adminhtml\Category\Tree
{
    ...
    {
        return $this->getUrl('branch8_blog/category/jsonTree');
    }
    ...
    {
        return $this->getUrl('branch8_blog/category/move');
    }
