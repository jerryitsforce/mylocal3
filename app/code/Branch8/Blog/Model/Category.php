 ...
 * @method Category setImage($image)
 * @method Category setBackgroundSize($backgroundSize)
 * @method Category setBackgroundPosition($backgroundPosition)
...
class Category extends AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'branch8_blog_category';
     ...
     * @var string
     */
    protected $_cacheTag = 'branch8_blog_category';
     ...
     * @var string
     */
    protected $_eventPrefix = 'branch8_blog_category';
    ...
    public function getSelectedPostsCollection()
    {
        if (!$this->postCollection) {
            ...
            $collection->join(
                ['cat' => $this->getResource()->getTable('branch8_blog_post_category')],
