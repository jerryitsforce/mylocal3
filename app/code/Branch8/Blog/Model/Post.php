...
use Branch8\Blog\Model\ResourceModel\Category\CollectionFactory as CategoryCollectionFactory;
use Branch8\Blog\Model\ResourceModel\Post as PostResource;
use Branch8\Blog\Model\ResourceModel\Post\Collection;
use Branch8\Blog\Model\ResourceModel\Post\CollectionFactory as PostCollectionFactory;
use Branch8\Blog\Model\ResourceModel\Tag\CollectionFactory;
use Branch8\Blog\Model\ResourceModel\Topic\CollectionFactory as TopicCollectionFactory;
 ...
 * @method Post setImageTwo($imageTwo)
 * @method Post setImageThree($imageThree)
 * @method Post setBackgroundSize($backgroundSize)
 * @method Post setBackgroundPosition($backgroundPosition)
 ...
 * @method mixed getImageTwo()
 * @method mixed getImageThree()
 * @method mixed getBackgroundSize()
 * @method mixed getBackgroundPosition()
...
class Post extends AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'branch8_blog_post';
     ...
     * @var string
     */
    protected $_cacheTag = 'branch8_blog_post';
     ...
     * @var string
     */
    protected $_eventPrefix = 'branch8_blog_post';
    ...
    public function getSelectedTagsCollection()
    {
        if ($this->tagCollection === null) {
            ...
            $collection->getSelect()->join(
                $this->getResource()->getTable('branch8_blog_post_tag'),
                'main_table.tag_id=' . $this->getResource()->getTable('branch8_blog_post_tag') . '.tag_id AND '
                . $this->getResource()->getTable('branch8_blog_post_tag') . '.post_id=' . $this->getId(),
                ['position']
    ...
    public function getSelectedTopicsCollection()
    {
        if ($this->topicCollection === null) {
            ...
            $collection->join(
                $this->getResource()->getTable('branch8_blog_post_topic'),
                'main_table.topic_id=' . $this->getResource()->getTable('branch8_blog_post_topic') . '.topic_id AND '
                . $this->getResource()->getTable('branch8_blog_post_topic') . '.post_id=' . $this->getId(),
                ['position']
            );
    ...
    public function getSelectedCategoriesCollection()
    {
        if ($this->categoryCollection === null) {
            ...
            $collection->join(
                $this->getResource()->getTable('branch8_blog_post_category'),
                'main_table.category_id=' . $this->getResource()->getTable('branch8_blog_post_category') .
                '.category_id AND ' . $this->getResource()->getTable('branch8_blog_post_category') . '.post_id="'
                . $this->getId() . '"',
                ['position']
            );
    ...
    public function getRelatedPostsCollection()
    {
        ...
        if (count($topicIds)) {
            ...
            $collection->getSelect()
                ->join(
                    ['topic' => $this->getResource()->getTable('branch8_blog_post_topic')],
    ...
    public function getSelectedProductsCollection()
    {
        if ($this->productCollection === null) {
            ...
            $collection->getSelect()->join(
                $this->getResource()->getTable('branch8_blog_post_product'),
                'e.entity_id=' . $this->getResource()->getTable('branch8_blog_post_product')
                . '.entity_id AND ' . $this->getResource()->getTable('branch8_blog_post_product') . '.post_id='
                . $this->getId(),
                ['position']
            );
