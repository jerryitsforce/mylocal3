...
class Tag extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->tagPostTable = $this->getTable('branch8_blog_post_tag');
    }
    ...
    {
        $this->_init('branch8_blog_tag', 'tag_id');
    }
    ...
    /**
     * @param \Branch8\Blog\Model\Tag $tag
     *
     * @return array
     */
    public function getPostsPosition(\Branch8\Blog\Model\Tag $tag)
    {
     ...
     * @return $this
     */
    protected function savePostRelation(\Branch8\Blog\Model\Tag $tag)
    {
