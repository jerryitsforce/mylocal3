...
class Post extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->postTagTable      = $this->getTable('branch8_blog_post_tag');
        $this->postTopicTable    = $this->getTable('branch8_blog_post_topic');
        $this->postCategoryTable = $this->getTable('branch8_blog_post_category');
        $this->postProductTable  = $this->getTable('branch8_blog_post_product');
        $this->postTrafficTable  = $this->getTable('branch8_blog_post_traffic');
        $this->postAuthorTable   = $this->getTable('branch8_blog_author');
    }
    ...
    {
        $this->_init('branch8_blog_post', 'post_id');
    }
    ...
    public function saveTopicRelation(PostModel $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'branch8_blog_post_change_topics',
    ...
    public function saveCategoryRelation(PostModel $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'branch8_blog_post_change_categories',
    ...
    public function saveProductRelation(PostModel $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'branch8_blog_post_change_products',
