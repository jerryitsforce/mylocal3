...
namespace Branch8\Blog\Model\ResourceModel\Comment\Grid;
...
use Branch8\Blog\Model\ResourceModel\Comment;
use Psr\Log\LoggerInterface as Logger;
use Zend_Db_Expr;

/**
 * Class Collection
 * @package Branch8\Blog\Model\ResourceModel\Comment\Grid
 */
class Collection extends SearchResult
{
    ...
    public function __construct(
        ...
        $mainTable = 'branch8_blog_comment',
    ...
    public function addPostName()
    {
        $this->getSelect()->joinLeft(
            ['mp' => $this->getTable('branch8_blog_post')],
