...
namespace Branch8\Blog\Model\ResourceModel\Category;
...
use Branch8\Blog\Model\ResourceModel\Category;
use Branch8\Blog\Model\Category as CategoryModel;

/**
 * Class Tree
 * @package Branch8\Blog\Model\ResourceModel\Category
 */
class Tree extends Dbp
{
    ...
    public function __construct(
        ...
        parent::__construct(
            $coreResource->getConnection('branch8_blog_write'),
            $coreResource->getTableName('branch8_blog_category'),
            [
    ...
    public function initInactiveCategoryIds()
    {
        ...
        $this->eventManager->dispatch('branch8_blog_category_tree_init_inactive_category_ids', ['tree' => $this]);
