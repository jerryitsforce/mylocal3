...
class Topic extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->topicPostTable = $this->getTable('branch8_blog_post_topic');
    }
    ...
    {
        $this->_init('branch8_blog_topic', 'topic_id');
    }
    ...
    /**
     * @param \Branch8\Blog\Model\Topic $topic
     *
     * @return array
     */
    public function getPostsPosition(\Branch8\Blog\Model\Topic $topic)
    {
     ...
     * @return $this
     */
    protected function savePostRelation(\Branch8\Blog\Model\Topic $topic)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'branch8_blog_topic_change_posts',
