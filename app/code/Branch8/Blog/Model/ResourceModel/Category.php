...
class Category extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->categoryPostTable = $this->getTable('branch8_blog_post_category');
    }
    ...
    {
        $this->_init('branch8_blog_category', 'category_id');
    }
    ...
    protected function getMaxPosition($path)
    {
        ...
        $select        = $adapter->select()->from(
            $this->getTable('branch8_blog_category'),
            'MAX(' . $positionField . ')'
        )->where(
    ...
    public function savePostRelation(CategoryModel $category)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'branch8_blog_category_change_posts',
