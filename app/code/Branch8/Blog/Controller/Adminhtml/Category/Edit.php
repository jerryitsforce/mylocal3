...
class Edit extends Category
{
    ...
    public function execute()
    {
         ...
         */
        $data = $this->_getSession()->getData('branch8_blog_category_data', true);
        ...
        if ($this->getRequest()->getQuery('isAjax')) {
            ...
            $this->_eventManager->dispatch(
                'branch8_blog_category_prepare_ajax_response',
        ...
        $resultPage->setActiveMenu('Branch8_Blog::category');
