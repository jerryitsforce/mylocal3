...
class ManagerApprove extends Column
{
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (!$this->authorization->isAllowed('Branch8_MarketplaceProduct::manager_product_approval')) {
                    ...
                    $item[$fieldName . '_html'] = "<button class='button'><span>" . __('Manager Approve') . '</span></button>';
                    ...
                    $item[$fieldName . '_formaction'] = $this->context->getUrl('marketplacectrl/managerProduct/approve');
                }
            }
        }
        return $dataSource;
