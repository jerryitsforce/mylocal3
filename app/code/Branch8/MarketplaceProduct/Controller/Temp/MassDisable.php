...
class MassDisable extends Action implements \Magento\Framework\App\CsrfAwareActionInterface
{
    ...
    public function __construct(
        ...
        $this->_productTempCollectionFactory = $collectionFactory;
        ...
        if ($isPartner == 1) {
            try {
                ...
                foreach ($collection as $item) {
                    ...
                    $information['status'] = SellerProduct::STATUS_DISABLED;
                    $item->setStatus(SellerProduct::STATUS_DISABLED);
                ...
                $this->messageManager->addSuccess(
                    __('A total of %1 record(s) have been disabled. Please note: The status of new products cannot be edited. Thank you.', $total)
                );
            } catch (\Exception $e) {
