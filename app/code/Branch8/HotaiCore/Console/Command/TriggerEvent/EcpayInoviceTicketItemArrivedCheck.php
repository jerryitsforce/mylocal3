...
class EcpayInoviceTicketItemArrivedCheck extends Command
{
    const LOG_FOLDER_NAME = 'HotaiCore/Console/TriggerEvent/EcpayInoviceTicketItemArrivedCheck';
    ...
    {
        $this->setName('hotai_core:trigger_event:ecpay_inovice_ticket_item_arrived_check');
        $this->setDescription('Pass in --order_id=123, will trigger event "ecpay_inovice_ticket_item_arrived_check".');
