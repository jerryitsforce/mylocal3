...
class CheckTicketOrderAllCompleteManually extends Command
{
    const LOG_FOLDER_NAME = 'HotaiCore/Console/TriggerEvent/CheckTicketOrderAllCompleteManually';
    ...
    {
        $this->setName('hotai_core:trigger_event:check_ticket_order_all_complete_manually');
        $this->setDescription('Pass in --order_id=123, will trigger event "check_ticket_order_all_complete_manually".');
