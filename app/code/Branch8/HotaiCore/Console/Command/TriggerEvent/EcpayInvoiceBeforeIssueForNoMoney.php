...
class EcpayInvoiceBeforeIssueForNoMoney extends Command
{
    const LOG_FOLDER_NAME = 'HotaiCore/Console/TriggerEvent/EcpayInvoiceBeforeIssueForNoMoney';
    ...
    {
        $this->setName('hotai_core:trigger_event:ecpay_invoice_before_issue_for_no_money');
        $this->setDescription('Pass in --order_id=123, will trigger event "ecpay_invoice_before_issue_for_no_money".');
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->eventManager->dispatch(
            InvoiceService::ECPAY_INVOICE_BEFORE_ISSUE_FOR_NO_MONEY,
            [
                "orderId" => $orderId,
            ]
        );
