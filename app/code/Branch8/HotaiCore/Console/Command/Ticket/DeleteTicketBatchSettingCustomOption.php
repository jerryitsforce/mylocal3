...
class DeleteTicketBatchSettingCustomOption extends Command
{
    const LOG_FOLDER_NAME = 'HotaiCore/Console/DeleteTicketBatchSettingCustomOption';
    ...
    {
        $this->setName('hotai_core:delete_ticket_batch_setting_custom_option');
        $this->setDescription('Pass in --product_ids=100,101,102, will execute deleteBatchSettingCustomOption function under app/code/Branch8/HotaiCore/Helper/VirtualProduct.php.');
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach($this->productIdArray as $productId) {
            $this->virtualProductHelper->deleteBatchSettingCustomOption($productId);
        }
