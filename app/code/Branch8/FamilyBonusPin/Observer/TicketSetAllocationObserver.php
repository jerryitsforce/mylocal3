...
use Branch8\FamilyBonusPin\Model\FamilyBonusPinTicketRecordRepository as TicketRecordRepository;
    ...
    private function setTicketRecordUpdateValue(TicketRecordModel $record, int $quoteItemId): TicketRecordModel
    {
        ...
        $memoMessage = $this->hotaiCoreCommonHelper->prepareMemoStringForUpdate(
            ...
            [
                ...
                "Title"     => "FamilyBonusPin TicketSetAllocationObserver triggered by event: {$this->eventName}",
