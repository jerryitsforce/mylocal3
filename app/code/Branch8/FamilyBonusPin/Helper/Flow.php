...
use Branch8\FamilyBonusPin\Model\FamilyBonusPinTicketRecord as Record;
...
{
    const LOG_FOLDER_NAME = 'FamilyBonusPin/Flow';
    ...
    public function cancelTickets(int $orderItemId): void
    {
        ...
        try {
            ...
            $this->commonHelper->writeLogIfEnabled(
                json_encode([
                    "Title"   => "Something went wrong while executing FamilyBonusPin cancelTickets transaction.",
    ...
    protected function resetAllocatedRecords(Record $record): void
    {
        ...
        $memoMessage = $this->hotaiCoreCommonHelper->prepareMemoStringForUpdate(
            ...
            [
                ...
                "Title"     => "FamilyBonusPin cancelTickets flow resetAllocatedRecords executed.",
        ...
        foreach ($collection->getItems() as $record) {
            ...
            $memoMessage = $this->hotaiCoreCommonHelper->prepareMemoStringForUpdate(
                ...
                [
                    "Timestamp" => time(),
                    "Datetime"  => date("Y-m-d H:i:s"),
                    "Title"     => "FamilyBonusPin cancelTickets flow called, set status to STATUS_IMPORTED.",
        ...
        foreach ($collection->getItems() as $record) {
            ...
            $memoMessage = $this->hotaiCoreCommonHelper->prepareMemoStringForUpdate(
                ...
                [
                    "Timestamp" => time(),
                    "Datetime"  => date("Y-m-d H:i:s"),
                    "Title"     => "FamilyBonusPin cancelTickets flow called, set status to STATUS_RETURNED.",
                    "Message"   => "Before status: {$beforeStatus}, after status: {$afterStatus}",
                ]
            );
    ...
    {
        $recordTableName = \Branch8\FamilyBonusPin\Model\FamilyBonusPinTicketRecord::TABLE_NAME;
        $batchTableName = \Branch8\FamilyBonusPin\Model\FamilyBonusPinBatchSetting::TABLE_NAME;

        $recordIdField = \Branch8\FamilyBonusPin\Model\FamilyBonusPinTicketRecord::RECORD_ID;
        $batchSettingIdFieldInBatchTable = \Branch8\FamilyBonusPin\Model\FamilyBonusPinBatchSetting::SETTING_ID;
        $batchSettingIdFieldInRecordTable = \Branch8\FamilyBonusPin\Model\FamilyBonusPinTicketRecord::BATCH_SETTING_ID;
        $productIdField = \Branch8\FamilyBonusPin\Model\FamilyBonusPinBatchSetting::BELONG_TO_PRODUCT_ID;
        $batchCodeField = \Branch8\FamilyBonusPin\Model\FamilyBonusPinBatchSetting::BATCH_CODE;
        $batchSaleStartTimeField = \Branch8\FamilyBonusPin\Model\FamilyBonusPinBatchSetting::SALE_START_TIME;
        $batchSaleEndTimeField = \Branch8\FamilyBonusPin\Model\FamilyBonusPinBatchSetting::SALE_END_TIME;
        $statusField = \Branch8\FamilyBonusPin\Model\FamilyBonusPinTicketRecord::STATUS;
