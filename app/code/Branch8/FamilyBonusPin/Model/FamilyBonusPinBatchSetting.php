...
class FamilyBonusPinBatchSetting extends AbstractModel implements FamilyBonusPinBatchSettingInterface
{
    const TABLE_NAME    = "family_bonus_pin_batch_setting_v2";
    ...
    {
        $this->_init(
            \Branch8\FamilyBonusPin\Model\ResourceModel\FamilyBonusPinBatchSetting::class
        );
    }
