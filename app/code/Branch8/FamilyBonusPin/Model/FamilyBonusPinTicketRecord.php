...
class FamilyBonusPinTicketRecord extends AbstractModel implements FamilyBonusPinTicketRecordInterface
{
    const TABLE_NAME    = "family_bonus_pin_ticket_record_v2";
    ...
    {
        $this->_init(
            \Branch8\FamilyBonusPin\Model\ResourceModel\FamilyBonusPinTicketRecord::class
        );
    }
