...
namespace Branch8\MarketplaceStaging\Ui\Component\Listing\Column\Entity;

use Magento\Framework\View\Element\UiComponent\ContextInterface;
use Magento\Framework\View\Element\UiComponentFactory;
use Branch8\MarketplaceStaging\Model\Preview\UrlBuilder;
use Magento\Ui\Component\Listing\Columns\Column;
use Magento\Staging\Ui\Component\Listing\Column\Entity\UrlProviderInterface;

/**
 * Entity for listing column Actions
 */
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                if (isset($item['id'])) {
                    ...
                    $item[$this->getData('name')] = [
                        ...
                        'preview' => [
                            'href' => $this->previewUrlBuilder->getPreviewUrl($item['id'], $url, $store),
                            'label' => __('Preview'),
                            'target' => '_blank',
                        ],
                    ];
