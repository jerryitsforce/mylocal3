...
namespace Branch8\MarketplaceStaging\Block\Widget\Button\Toolbar;

use Branch8\MarketplaceStaging\Block\Widget\Button\ContextInterface;

/**
 * @method \Branch8\MarketplaceStaging\Block\Widget\Button\Item getButtonItem()
...
class Container extends \Magento\Framework\View\Element\AbstractBlock
{
     ...
     * @return \Branch8\MarketplaceStaging\Block\Widget\Button
     */
    protected function createButton($blockName, $blockClassName = null)
    {
        if (null === $blockClassName) {
            $blockClassName = \Branch8\MarketplaceStaging\Block\Widget\Button::class;
        }
