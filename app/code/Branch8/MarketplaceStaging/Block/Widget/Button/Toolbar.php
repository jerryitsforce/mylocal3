...
class Toolbar implements ToolbarInterface
{
     ...
     * @param \Branch8\MarketplaceStaging\Block\Widget\Button\Item $buttonItem
     * @return \Branch8\MarketplaceStaging\Block\Widget\Button\Toolbar\Container
     */
    protected function createContainer(LayoutInterface $layout, $containerName, $buttonItem)
    {
        $container = $layout->createBlock(
            \Branch8\MarketplaceStaging\Block\Widget\Button\Toolbar\Container::class,
            $containerName,
