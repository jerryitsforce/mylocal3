 ...
 */
namespace Branch8\MarketplaceStaging\Block\Product\Helper\Form;

use Magento\Framework\Registry;
use Magento\Framework\Data\Form;
use Magento\Catalog\Block\Adminhtml\Product\Helper\Form\Gallery as CatalogGallery;
use Branch8\MarketplaceStaging\Model\Product\Locator\StagingLocator;
...
class Gallery extends CatalogGallery
{
     ...
     * @var string
     */
    protected $formName = 'marketplacestaging_update_form';
