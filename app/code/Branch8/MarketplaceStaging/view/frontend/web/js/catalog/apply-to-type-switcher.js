define([
    ...
    return {
         ...
         */
        bindAll: function () {
            $('[data-form=staging-product] [data-role=tabs]').on(
                'contentUpdated',
            ...
            $(document).on('changeStageTypeProduct', this._switchToTypeByApplyAttr.bind(this));
        },

        /**
         * Constructor component
         */
        'Branch8_MarketplaceStaging/js/catalog/apply-to-type-switcher': function () {
            this.bindAll();
