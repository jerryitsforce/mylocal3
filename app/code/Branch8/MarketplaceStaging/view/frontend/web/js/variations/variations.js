...
define([
    ...
    return Component.extend({
        defaults: {
            ...
            modules: {
                associatedProductGrid: '${ $.stagingConfigurableProductGrid }'
            }
        },
        initialize: function () {
            this._super();
        ...
        initImageUpload: function () {
            require([
                ...
                var matrix = $('[data-role=staging-product-variations-matrix]');
