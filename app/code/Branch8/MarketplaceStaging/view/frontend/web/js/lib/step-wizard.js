...
define([
    ...
    StagingWizard = function (steps, modalClass) {
        this.steps = steps;
        this.index = 0;
        this.data = {};
        ...
        this.initSelectors = function (modalClass) {
            var elementSelector = '[data-role=staging-steps-wizard-main]';

            this.nextLabel = '[data-role="staging-step-wizard-next"]';
            this.prevLabel = '[data-role="staging-step-wizard-prev"]';
    ...
    return Component.extend({
        ...
        open: function () {
            ...
            this.wizard = new StagingWizard(this.steps, this.modalClass);
            $('[data-role=staging-step-wizard-dialog]').trigger('openModal');
        },
        close: function () {
            ...
            $('[data-role=staging-step-wizard-dialog]').trigger('closeModal');
        },
