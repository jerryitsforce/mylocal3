define([
    ...
    return Abstract.extend({
        defaults: {
            ...
            optgroupTmpl: 'Branch8_Catalog/grid/filters/elements/ui-select-optgroup',
        ...
        toggleOptionSelected: function (data) {
            ...
            let optionsTree = this.cacheOptions.plain;
            let entry = optionsTree.find(function(e) { return e.value === data.value; });
            if (entry && entry.level < this.allowSelectLevel) {
                return this;
            }
            ...
            if (!this.multiple) {
                ...
                if (!isSelected) { /*eslint no-lonely-if: 0*/
                    ...
                    /** 
                     * I saw that it was wrong, but I keep current UI, current behavior, my task not update them. 
                     * I only fix issue for my task 
                     * I keep old code, it was so wrong, value is integer but do an array operation(_.without(arr, arr))
                     * */
                    this.value('');
                }
            }
            $('[name="'+this.element+'"]').trigger('change');
            return this;
        },
        ...
        onRootListRender: function (element) {
            ...
            $('#edit-product').mage('validation', {});
            $('#staging-product').mage('validation', {});
        },
