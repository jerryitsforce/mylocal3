define([
    ...
    return {
        ...
        configurationSectionMessageHandler: (function () {
            var title = $('[data-role="staging-product-create-configuration-info"]'),
                buttons = $('[data-action="staging-product-create-configuration-buttons"]'),
        ...
        bindAll: function () {
            $(document).on('changeConfigurableTypeProduct', function (event, isConfigurable) {
                $(document).trigger('setStageTypeProduct', isConfigurable ? 'configurable' : null);
            });
         ...
         */
        'Branch8_MarketplaceStaging/js/configurable-type-handler': function (data) {
