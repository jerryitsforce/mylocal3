 ...
 */
class SearchCouponCodeOptions extends Action implements HttpGetActionInterface
{
    ...
    private GetCouponCodeOptions $getOptions;

    /**
     * @param GetCouponCodeOptions $getOptions
     * @param Context $context
     * @param CustomLogger $logger
     */
    public function __construct(
        GetCouponCodeOptions $getOptions,
        Context              $context,
        CustomLogger         $logger
    )
    {
    ...
    public function execute()
    {
        ...
        try {
            $filters = [];
            if ($searchKey) {
                $filters[] = ['field' => 'coupon_code LIKE (?)', 'value' => '%' . $searchKey . '%'];
            }
