...
namespace Branch8\MarketPlaceParentOrderHelpDesk\Controller\Ticket;
...
/**
 * Load Recent Parent Orders
 */
class LoadRecentParentOrders implements HttpGetActionInterface
{
    private FindYourParentOrderAction $serviceFinder;
     ...
     * @param FindYourParentOrderAction $action
     */
    public function __construct(
        ...
        FindYourParentOrderAction                        $action
    )
    {
