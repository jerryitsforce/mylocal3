...
define(["Magento_PageBuilder/js/mass-converter/widget-directive-abstract", "Magento_PageBuilder/js/utils/object"], function (_widgetDirectiveAbstract, _object) {
  ...
  var WidgetDirective = /*#__PURE__*/function (_widgetDirectiveAbstr) {
    ...
    _proto.fromDom = function fromDom(data, config) {
      ...
      data.past_days = attributes.past_days;
      data.title = attributes.title;
      data.conversion_rate = attributes.conversion_rate;
      data.view_more_url = attributes.view_more_url;
    ...
    _proto.toDom = function toDom(data, config) {
      var attributes = {
        type: "Branch8\\BestSeller\\Block\\Widget\\BestSellerProduct",
        template: "Branch8_BestSeller::widget/best_seller_product_carousel.phtml",
        anchor_text: "",
        id_path: "",
        show_pager: 0,
        ...
        view_more_url: data.view_more_url,
        condition_option: data.condition_option,
        condition_option_value: "",
        type_name: "Best Seller Products Carousel",
