define([
    ...
    var newWidgetMixin = {
        ...
        _create: function () {
            ...
            if($('body').hasClass('account') && $('.form-address-edit.normal').length){
                ...
                // console.log({cityListId: this.options.cityListId, regionListId: this.options.regionListId});
        ...
        _updateCity: function () {
            ...
            if($('body').hasClass('account') && $('.form-address-edit.normal').length){
                ...
                // console.log({cityList, cityValue, city, options: this.options}); 
        ...
        _updateRegion: function (country) {
            ...
            // console.log({country, regions: this.options.regionJson[country], default: this.options.defaultRegion});
    ...
    return function (targetWidget) {
        $.widget('mage.directoryRegionUpdater', targetWidget, newWidgetMixin); 
