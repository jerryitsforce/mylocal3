...
class CategoryAttributeDateFrom implements DataPatchInterface
{
    /**
    ...
    public function apply() {
        ...
        $attribute = $this->eavConfig->getAttribute(Category::ENTITY, 'catalog_price_rule_date_from');
