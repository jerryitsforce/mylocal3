...
class CategoryVipAttribute implements DataPatchInterface
{
    /**
    ...
    public function apply() {
        ...
        $eavSetup->addAttribute(
            ...
            [
                'type' => 'varchar',
                'label' => 'Catalog Price Rule Id (VIP)',
                'input' => 'text',
                'required' => false,
                'sort_order' => 52,
                'global'   => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_STORE,
                'group' => 'Catalog Price Rule Id (VIP)',
                'visible'  => true,
                'default'  => '',
        ...
        $attribute = $this->eavConfig->getAttribute(Category::ENTITY, 'catalog_price_rule_vip_id');
