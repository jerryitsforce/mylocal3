...
namespace Branch8\Spin2Win\Setup\Patch\Data;
...
class SpinToWinNotificationType implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        $rootPath = $this->path->getPath('module', 'Branch8_Spin2Win');
        // Get media folder
        ...
        $data = [
            [
                'name' => 'Spin to win notification',
                'description' => 'Spin to win notification',
                'is_category' => 1,
                'default_type' => 'spin_to_win',
                'icon' => '[{
                                "name": "spin_to_win",
                                "type": "image/png",
                                "url": "' . $mediaUrl . '/spin_to_win.png",
                                "size":"1500"
                    }]'
            ]
        ];
        ...
        $notificationData = [
            ...
            'name' => 'Spin to Win notification',
            'is_active' => 1,
            'notification_type' => 'spin_to_win',
            'condition' => NULL,
            'image' => NULL,
            'store_view' => '["0","1"]',
            'customer_group' => '""',
            'description' => 'Notify to customer when they win a prize',
            'redirect_url' => NULL,
            'total_sent' => 0,
            'total_click' => 0,
