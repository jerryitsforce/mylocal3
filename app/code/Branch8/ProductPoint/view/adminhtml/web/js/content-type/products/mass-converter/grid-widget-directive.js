...
define(["Magento_PageBuilder/js/mass-converter/widget-directive-abstract", "Magento_PageBuilder/js/utils/object"], function (_widgetDirectiveAbstract, _object) {
  ...
  var WidgetDirective = /*#__PURE__*/function (_widgetDirectiveAbstr) {
    ...
    _proto.fromDom = function fromDom(data, config) {
      ...
      data.grid_products_count = attributes.products_count;
    ...
    _proto.toDom = function toDom(data, config) {
      var attributes = {
        type: "Branch8\\ProductPoint\\Block\\Widget\\ProductPoint",
        template: "Branch8_ProductPoint::widget/point_product_grid.phtml",
        anchor_text: "",
        id_path: "",
        show_pager: 0,
        products_count: data.grid_products_count,
        title: data.title,
        sub_title: data.sub_title,
        condition_option: data.condition_option,
        condition_option_value: "",
        type_name: "Point Products Grid",
