...
class UpdateShipmentEtaManagement extends AbstractModel implements \Branch8\Hopes\Api\UpdateShipmentEtaManagementInterface
{
    /**
     * Log type value used by admin multiselect.
     */
    private const LOG_TYPE = 'UpdateShipmentEtaManagement';
     ...
     * {@inheritdoc}
     */
    public function postUpdateShipmentEta()
    {

        $this->hopesLog->log(self::LOG_TYPE, '[Start] UpdateShipmentEta Start');
