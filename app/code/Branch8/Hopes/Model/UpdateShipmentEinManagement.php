...
class UpdateShipmentEinManagement extends AbstractModel implements \Branch8\Hopes\Api\UpdateShipmentEinManagementInterface
{
    /**
     * Log type value used by admin multiselect.
     */
    private const LOG_TYPE = 'UpdateShipmentEinManagement';
     ...
     * {@inheritdoc}
     */
    public function postUpdateShipmentEin()
    {

        $this->hopesLog->log(self::LOG_TYPE, '[Start] UpdateShipmentEin Start');
