...
use Branch8\FamilyBonusPin\Model\FamilyBonusPinBatchSetting as BatchModel;
use Branch8\FamilyBonusPin\Model\FamilyBonusPinBatchSettingRepository as BatchRepository;
...
class FamilyBonusPin
{
    const LOG_FOLDER_NAME = "TicketApi/Api/NotifyUsed/FamilyBonusPin";
    ...
    public function handleUsedUpdate(): void
    {
        ...
        /** @var BatchModel $batchSetting */
        $batchSetting = $this->batchRepository->getById($model->getBatchSettingId());
