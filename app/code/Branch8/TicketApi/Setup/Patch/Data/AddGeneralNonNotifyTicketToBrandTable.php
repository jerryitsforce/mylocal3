...
use Branch8\TicketApi\Setup\Patch\Data\AddGeneralNotifyTicketToBrandTable;

class AddGeneralNonNotifyTicketToBrandTable implements DataPatchInterface
{
    ...
    {
        // 20241114, add BRAND_CODE_GENERAL_NON_NOTIFY
        // just for "check" API.
        // app/code/Branch8/TicketApi/Model/Api/Check.php
    ...
    public static function getDependencies()
    {
        return [
            ...
            AddGeneralNotifyTicketToBrandTable::class,
        ];
    }
}
