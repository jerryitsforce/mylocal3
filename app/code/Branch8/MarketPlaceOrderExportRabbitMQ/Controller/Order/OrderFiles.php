...
/**
 * Controller for the 'marketplace/order/orderfiles' URL route.
 */
class OrderFiles extends Action implements \Magento\Framework\App\CsrfAwareActionInterface
{
    /**
        ...
        if ($isPartner == 1) {
           ...
           // $resultPage->addHandle('marketplace_layout2_order_history');
            $resultPage->getConfig()->getTitle()->set(
                __('Order Download Files')
            );
            if ($helper->getIsSeparatePanel()) {
                $resultPage->addHandle('marketplace_layout2_orderfiles_download_listing');
            }
            return $resultPage;
        } else {
