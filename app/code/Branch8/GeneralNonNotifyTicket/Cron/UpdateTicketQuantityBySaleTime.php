...
namespace Branch8\GeneralNonNotifyTicket\Cron;
...
use Branch8\GeneralNonNotifyTicket\Model\GeneralNonNotifyTicketRecordRepository as RecordRepository;
...
{
    const LOG_FOLDER_NAME = 'GeneralNonNotifyTicket/Cron/UpdateTicketQuantityBySaleTime';
    ...
    {
        try {
            $this->writeLog("GeneralNonNotifyTicket UpdateTicketQuantityBySaleTime cron start.");
            ...
            $this->writeLog("GeneralNonNotifyTicket UpdateTicketQuantityBySaleTime cron end.");
        } catch (\Exception $e) {
    ...
    private function getTargetProductCollection(): ProductCollection
    {
        ...
        $productCollection->addAttributeToSelect(['entity_id', 'sku'])
            ...
            ->addAttributeToFilter(
                ...
                ['eq', VirtualProductType::TYPE_GENERAL_NON_NOTIFY_TICKET]
            )->load();
