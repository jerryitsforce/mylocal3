...
use Branch8\GeneralNonNotifyTicket\Model\GeneralNonNotifyTicketBatchSetting as BatchSettingModel;
use Branch8\GeneralNonNotifyTicket\Model\GeneralNonNotifyTicketRecord as TicketRecordModel;
use Branch8\GeneralNonNotifyTicket\Model\GeneralNonNotifyTicketRecordRepository as TicketRecordRepository;
    ...
    private function setTicketRecordUpdateValue(TicketRecordModel $record, int $quoteItemId): TicketRecordModel
    {
        ...
        $memoMessage = $this->hotaiCoreCommonHelper->prepareMemoStringForUpdate(
            ...
            [
                ...
                "Title"     => "GeneralNonNotifyTicket TicketSetAllocationObserver triggered by event: {$this->eventName}",
