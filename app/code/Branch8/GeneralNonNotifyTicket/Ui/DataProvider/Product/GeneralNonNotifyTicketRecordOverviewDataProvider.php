...
namespace Branch8\GeneralNonNotifyTicket\Ui\DataProvider\Product;
...
class GeneralNonNotifyTicketRecordOverviewDataProvider extends AbstractDataProvider
{
    /**
    ...
    /**
     * 取得與此產品相關的所有ticket collection
     *
     * @return \Branch8\GeneralNonNotifyTicket\Model\ResourceModel\GeneralNonNotifyTicketRecord\Collection
     */
    private function getTotalCollection(): \Branch8\GeneralNonNotifyTicket\Model\ResourceModel\GeneralNonNotifyTicketRecord\Collection
    {
        $this->getCollection()
            ->join(
                ['general_non_notify_ticket_batch_setting' => 'general_non_notify_ticket_batch_setting'],
                'main_table.batch_setting_id = general_non_notify_ticket_batch_setting.setting_id'
            )
            ->addFieldToFilter(
