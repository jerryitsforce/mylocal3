...
class GeneralNonNotifyTicketBatchSetting extends AbstractModel implements GeneralNonNotifyTicketBatchSettingInterface
{
    const TABLE_NAME    = "general_non_notify_ticket_batch_setting";
    ...
    {
        $this->_init(
            \Branch8\GeneralNonNotifyTicket\Model\ResourceModel\GeneralNonNotifyTicketBatchSetting::class
        );
    }
