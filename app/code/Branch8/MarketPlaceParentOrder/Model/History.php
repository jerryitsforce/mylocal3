...
use Branch8\MarketPlaceParentOrder\Api\Data\ParentOrderHistoryInterface;
use Magento\Framework\Api\AttributeValueFactory;
use Magento\Framework\Model\AbstractExtensibleModel;

class History extends AbstractExtensibleModel implements ParentOrderHistoryInterface
{
    ...
    {
        $this->_init(
            \Branch8\MarketPlaceParentOrder\Model\ResourceModel\History::class
        );
    }
     ...
     * {@inheritdoc}
     *
     * @return \Branch8\MarketPlaceParentOrder\Api\Data\ParentOrderHistoryExtensionInterface|null
     */
     ...
     * {@inheritdoc}
     *
     * @param \Branch8\MarketPlaceParentOrder\Api\Data\ParentOrderHistoryExtensionInterface $extensionAttributes
     * @return $this
     */
    public function setExtensionAttributes(
        \Branch8\MarketPlaceParentOrder\Api\Data\ParentOrderHistoryExtensionInterface $extensionAttributes
    )
    {
    ...
    {
        if ($this->getParentOrder()) {
            return $this->getParentOrder()->getConfig()->getStateLabel($this->getStatus());
        }
        return null;
    }
}
