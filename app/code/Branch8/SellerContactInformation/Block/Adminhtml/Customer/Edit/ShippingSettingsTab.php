 ...
 */
class ShippingSettingsTab extends \Magento\Backend\Block\Template implements TabInterface
{
    /**
    ...
    {
        return __('Shipping And Freight Settings');
    }
    ...
    public function _toHtml()
    {
        ...
        $html .= $this->getLayout()->createBlock(
            \Branch8\SellerContactInformation\Block\Adminhtml\Customer\Edit\Tab\ShippingSettings::class
        )->toHtml();
