...
class Product extends \Magento\Rule\Model\Condition\Product\AbstractProduct implements ResetAfterRequestInterface
{
     ...
     * @inheritdoc
     */
    public function loadAttributeOptions($filterAttributes = [])
    {
    ...
    )
    {
        switch ($attribute->getBackendType()) {
            ...
            case 'int':
                ...
                break;
            default:
                $alias = 'at_' . hash('sha256', (string)$this->getId()) . $attribute->getAttributeCode();
    ...
    )
    {
        ...
        switch ($attribute->getBackendType()) {
            ...
            case 'text':
                ...
                break;
            default:
                $aliasDefault = 'at_' . hash('sha256', (string)$this->getId()) . $attribute->getAttributeCode() . '_default';
                $aliasStore = 'at_' . hash('sha256', (string)$this->getId()) . $attribute->getAttributeCode();
