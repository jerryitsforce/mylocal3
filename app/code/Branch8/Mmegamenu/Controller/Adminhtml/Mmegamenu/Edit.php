...
class Edit extends \Branch8\Mmegamenu\Controller\Adminhtml\Mmegamenu
{
    /**
     * Core registry
     *
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('mmegamenu_mmegamenu', $model);
        ...
        $this->_initAction()->_addBreadcrumb(
            ...
            $this->_view->getLayout()->createBlock('Branch8\Mmegamenu\Block\Adminhtml\Edit')
        );
