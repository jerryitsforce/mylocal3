...
class Editparent extends \Branch8\Mmegamenu\Controller\Adminhtml\Mmegamenu
{
    /**
     * Core registry
     *
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Branch8\Mmegamenu\Model\Parents');
        ...
        $this->_initAction()->_addBreadcrumb(
            ...
            $this->_view->getLayout()->createBlock('Branch8\Mmegamenu\Block\Adminhtml\Editparent')
        );
