...
class Mmegamenu extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('branch8_megamenu', 'megamenu_id');
    }
    ...
    protected function _afterSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $table = $this->getTable('branch8_megamenu_store');
    ...
    public function lookupStoreIds($id)
    {
        ...
        $select = $connection->select()->from(
            $this->getTable('branch8_megamenu_store'),
            'store_id'
        )->where(
    ...
    protected function _beforeDelete(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $this->getConnection()->delete($this->getTable('branch8_megamenu_store'), $condition);
