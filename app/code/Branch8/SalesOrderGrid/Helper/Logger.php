...
namespace Branch8\SalesOrderGrid\Helper;

use Branch8\HotaiCore\Helper\DebugLog;
use Psr\Log\LoggerInterface;

/**
 * Logger helper for SalesOrderGrid
 */
class Logger extends DebugLog
{
    ...
    {
        if ($this->isEnable('Branch8_SalesOrderGrid', 'system')) {
    ...
    {
        if ($this->isEnable('Branch8_SalesOrderGrid', 'exception')) {
