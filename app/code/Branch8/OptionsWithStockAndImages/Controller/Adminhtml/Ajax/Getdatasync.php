...
namespace Branch8\OptionsWithStockAndImages\Controller\Adminhtml\Ajax;
...
class Getdatasync extends \Magento\Backend\App\Action implements HttpGetActionInterface
{
   ...
   /**
    ...
    {
        return $this->_authorization->isAllowed('Webkul_OptionsWithStockAndImages::syncdata_image_stock');
    }
}
