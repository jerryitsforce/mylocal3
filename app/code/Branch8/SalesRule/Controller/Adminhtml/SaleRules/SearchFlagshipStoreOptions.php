 ...
 */
class SearchFlagshipStoreOptions extends Action implements HttpGetActionInterface
{
    ...
    public function execute()
    {
        ...
        try {
            $filters = [];
            if ($searchKey) {
                $filters[] = ['field' => 'main_table.store_name LIKE (?)', 'value' => '%' . $searchKey . '%'];
            }
            $responseContent = $this->getFlagshipStoreOptions->get($filters, $pageNum, $limit);
