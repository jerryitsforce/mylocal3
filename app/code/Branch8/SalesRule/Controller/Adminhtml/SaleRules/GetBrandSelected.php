 ...
 */
class GetBrandSelected extends Action implements HttpGetActionInterface
{
     ...
     * @param GetBrandOptions $getBrandOptions
    ...
    )
    {
        ...
        $this->getOptions = $getBrandOptions;
    ...
    public function execute(): ResultInterface
    {
        ...
        $options = $this->getOptions->get([['field' => 'eaov.option_id IN (?)', 'value' => $ids]])['options'];
