...
class CreatedIn extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        $date = new \DateTime($upcomingEvent['start_time'], new \DateTimeZone('UTC'));
        if ($date) {
