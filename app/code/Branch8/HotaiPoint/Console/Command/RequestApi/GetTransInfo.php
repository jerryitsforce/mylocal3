...
class GetTransInfo extends Command
{
    const LOG_FOLDER_NAME = 'HotaiPoint/Console/Command/RequestApi/GetTransInfo';
    ...
    {
        $this->setName('hotai_point:request_api:GetTransInfo');
        $this->setDescription('Pass in --customer_id=123, will execute function Branch8\HotaiPoint\Helper\Api::requestApiGetTransInfo(int $customerId).');
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $apiResponse = $this->apiHelper->requestApiGetTransInfo($this->customerId);
