 ...
 */
namespace Branch8\MarketPlaceOrderExportAdminUi\Ui\Component;
...
class Listing extends \Magento\Ui\Component\Listing
{
    ...
    public function prepare()
    {
        ...
        if ($this->hasData('buttons')) {
            ...
            if ($this->authorizationModel->isAllowed('Magento_Sales::sales_download_order_notification') === false
            ) {
                unset($buttons['excel_downloadOrderNotification']);
            }
