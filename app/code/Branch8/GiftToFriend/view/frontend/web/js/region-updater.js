...
define([
    ...
    $.widget('b8.giftDirectoryRegionUpdater', {
        options: {
            regionTemplate:
        ...
        _create: function () {
            ...
            // set default region and city if provided
            if (this.options.defaultRegion) {
                $(this.options.regionListId).val(this.options.defaultRegion).removeClass('no-selected').change();
                $(this.options.cityListId).val(this.options.defaultCity).removeClass('no-selected').change();
            }
        },
        ...
        _updateCity: function () {
            ...
            if(selectCity.length == 0){
                selectCity = $("<select class='required-entry' name='city_id' id='city_id'></select>");
            }
    ...
    return $.b8.giftDirectoryRegionUpdater;
});
